...
- (void)setUpTopBottomView
{
    ...
    shareLabel.frame = CGRectMake(0, DCMargin, kScreen_Width, 35);
    [self.view addSubview:shareLabel];
    
    
    UIView *line = [UIView new];
    line.backgroundColor = [[UIColor lightGrayColor]colorWithAlphaComponent:0.4];
    line.frame = CGRectMake(DCMargin, shareLabel.bottom + DCMargin, kScreen_Width - 2*DCMargin, 1);
    [self.view addSubview:line];
    
    self.collectionView.frame = CGRectMake(0, line.bottom + DCMargin, kScreen_Width, 160);
    ...
    cancelButton.frame = CGRectMake(DCMargin, self.collectionView.bottom + DCMargin * 2, kScreen_Width - 2 *DCMargin, 35);
