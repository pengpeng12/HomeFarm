...
#define NowScreenH kScreen_Height * 0.8
...
- (void)setUpBase
{
    ...
    self.tableView.frame = CGRectMake(0, 0, kScreen_Width, 100);
    self.tableView.rowHeight = 100;
    self.collectionView.frame = CGRectMake(0, self.tableView.bottom ,kScreen_Width , NowScreenH - 200);
...
- (void)setUpBottonView
{
    ...
    CGFloat buttonH = 50;
    CGFloat buttonW = kScreen_Width / titles.count;
