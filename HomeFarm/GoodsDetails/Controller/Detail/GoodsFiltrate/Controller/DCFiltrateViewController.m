...
//
#define FiltrateViewScreenW kScreen_Width * 0.8
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(5, DCMargin, FiltrateViewScreenW - DCMargin, kScreen_Height - 60);
...
- (void)setUpInit
{
    ...
    _filtrateConView.frame = CGRectMake(0, 0, FiltrateViewScreenW, kScreen_Height);
