...
- (CGFloat)cellHeight
{
    ...
    CGFloat contentH = [DCSpeedy dc_calculateTextSizeWithText:_comContent WithTextFont:14 WithMaxW:kScreen_Width - 20].height;
    
    CGFloat middle = contentH;
    
    //店家回复
    CGFloat comBackH = [DCSpeedy dc_calculateTextSizeWithText:_comReBack WithTextFont:13 WithMaxW:kScreen_Width - 40].height + DCMargin;
    CGFloat imagesH = 0;
    ...
    if (self.imgsArray.count) {
        ...
        //中间内容的Frame
        CGRect middleF = CGRectMake(DCMargin, top , kScreen_Width - 20, contentH);
