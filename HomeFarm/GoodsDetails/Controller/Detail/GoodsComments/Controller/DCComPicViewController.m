...
{
    CGFloat contentH = [DCSpeedy dc_calculateTextSizeWithText:_comComtent WithTextFont:13 WithMaxW:kScreen_Width - 20].height;
    _bottomView = [UIView new];
    [self.view insertSubview:_bottomView aboveSubview:_collectionView];
    _bottomView.frame = CGRectMake(0, kScreen_Height - (contentH + 45 + 15), kScreen_Width, (contentH + 45 + 15));
