...
- (void)setUpTopView
{
    _cameraTopView = [[DCCameraTopView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, 64)];
    WEAKSELF
...
- (void)setUpBottomView
{
    ...
    bottomView.frame = CGRectMake(0, kScreen_Height - 65, kScreen_Width, 50);
    ...
    supLabel.frame = CGRectMake(0, 0, kScreen_Width, 20);
    [bottomView addSubview:supLabel];
    
    NSArray *titles = @[@"快递单",@"物价码",@"二维码"];
    NSArray *images = @[@"",@"",@""];
    CGFloat btnW = (kScreen_Width - 80) / titles.count;
    CGFloat btnH = bottomView.height - supLabel.bottom - 5;
    CGFloat btnX;
