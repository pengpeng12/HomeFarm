...
- (void)awakeFromNib {
    ...
    //圆角
    [DCSpeedy dc_chageControlCircularWith:_myIconButton AndSetCornerRadius:_myIconButton.width * 0.5 SetBorderWidth:1 SetBorderColor:[UIColor whiteColor] canMasksToBounds:YES];
