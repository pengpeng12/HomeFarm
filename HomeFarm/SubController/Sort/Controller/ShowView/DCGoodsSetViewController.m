...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(0, 0, kScreen_Width, kScreen_Height - 64);
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return (_isSwitchGrid) ? CGSizeMake(kScreen_Width, 120) : CGSizeMake((kScreen_Width- 4)/2, (kScreen_Width- 4)/2 + 60);//列表、网格Cell
}

#pragma mark - head宽高
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section {
    return CGSizeMake(kScreen_Width, 40); //头部
}
...
{
    [self setUpAlterViewControllerWith:[DCFootprintGoodsViewController alloc] WithDistance: kScreen_Width* 0.4];
}
