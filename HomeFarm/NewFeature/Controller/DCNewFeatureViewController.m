...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nfImageView.image = (kDevice_Is_iPhoneX) ? [UIImage imageNamed:[NSString stringWithFormat:@"%@_x",_imageArray[indexPath.row]]]  : [UIImage imageNamed:_imageArray[indexPath.row]];
    ...
    cell.hideButtonClickBlock = ^{
        ...
        [weakSelf restoreRootViewController:[[FHTabBarController alloc] init]];
    };
